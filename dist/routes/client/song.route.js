...
router.get("/favorite", user_middleware_1.requireAuth, controller.favSong);
router.get("/detail/:slugSong", controller.detail);
router.patch("/like/:type/:songId", user_middleware_1.requireAuth, controller.like);
router.patch("/favorite/:type/:songId", user_middleware_1.requireAuth, controller.favoritePatch);
